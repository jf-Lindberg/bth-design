...
**Färghjul:**
![Färghjul Berghain nov 2021](%assets_url%/img/cw-berghain.png) {.website-img .wheel-img}
...
**Färghjul:**
![Färghjul Berghain okt 2021](%assets_url%/img/cw-berghain-okt.png) {.website-img .wheel-img}

**Typ av färgschema:**
Akromatisk med accent-färg alt. helt monokromatiskt.

**Typsnitt:**
Graphik på hela webbplatsen. Sans-serif.
...
**Färghjul:**
![Färghjul Columbia Theater](%assets_url%/img/cw-columbia.png) {.website-img .wheel-img}
...
**Färghjul:**
![Färghjul Berliner Mauer](%assets_url%/img/cw-berlinermauer.png){.website-img .wheel-img}

**Typ av färgschema:**
Helt och hållet monokromatiskt.

**Typsnitt:**
Verdana helt och hållet.
...
### Typsnitt
Webbplatsen använder bara ett typsnitt, vilket är ett sans-serif-typsnitt som heter Graphik. Eftersom det inte är särskilt mycket text (största delen av texten är rubriker av olika slag) funkar typsnittet väl. Det ger ett enkelt intryck och är lätt att läsa.
